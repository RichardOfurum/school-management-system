...
const PostForm = ({
  ...
  const onSubmit = handleSubmit((formData) => {
    try {
      ...
      payload.append("image", img?.secure_url || updateImg);
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <CldUploadWidget
          uploadPreset={"school"} // Ensure this is set in your env
          // uploadPreset={process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET} // Ensure this is set in your env
