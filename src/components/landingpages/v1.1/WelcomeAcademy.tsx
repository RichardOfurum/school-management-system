...
const WelcomeAcademy = () => {
  return (
    <section className="py-10 bg-white sm:py-16 lg:py-24">
        ...
        <div className="flex flex-col text-center gap-4 mb-14">
            <h1 className='text-xl font-bold text-sky-950 md:text-3xl lg:text-4xl'>Welcome to Ridges International School</h1>

            <p className='text-sm text-stone-700'>A place where education meets innovation, and students are prepared not just for exams, but for life.</p>
        </div>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 text-center sm:grid-cols-2 gap-y-8 lg:grid-cols-4 sm:gap-12">
                <div>
                    ...
                    <h3 className="mt-8 text-lg font-semibold text-black">Academic Excellence</h3>
                    <p className="mt-4 text-sm text-gray-600">Rigorous curriculum designed to challenge and inspire students to reach their full potential.</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-4 text-sm text-gray-600">A nurturing environment where every student feels valued, supported, and encouraged.</p>
                </div>
                ...
                <div>
                    ...
                    <h3 className="mt-8 text-lg font-semibold text-black">Character Development</h3>
                    <p className="mt-4 text-sm text-gray-600">Focus on developing well-rounded individuals with strong values and leadership skills.</p>
                </div>
                ...
                <div>
                    ...
                    <h3 className="mt-8 text-lg font-semibold text-black">Enriching Activities</h3>
                    <p className="mt-4 text-sm text-gray-600">Diverse extracurricular programs that foster creativity, teamwork, and personal growth.</p>
                </div>
            </div>
        </div>
    </section>
