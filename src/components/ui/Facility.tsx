  ...
  return (
    <div className='flex flex-col gap-10 my-10 bg-white'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 gap-10 p-10'>
                ...
                <div className="relative bg-[url('/herobg.png')] bg-cover bg-center h-60 flex flex-col justify-end items-start text-white p-8 rounded-lg">

                    <div className="absolute inset-0 bg-gradient-to-t from-neutral-900 to-transparent opacity-100 rounded-lg"></div>

                    <p className='z-10 font-semibold text-2xl'>Modern Classrooms</p>
                    <p className='z-10 text-left font-light'>Equipped with the lates technology to support interactive and engaging learning experience</p>
                
                </div>

                <div className="relative bg-[url('/hero.png')] bg-cover bg-center h-60 flex flex-col justify-end items-start text-white p-8 rounded-lg">

                    <div className="absolute inset-0 bg-gradient-to-t from-neutral-900 to-transparent opacity-100 rounded-lg">

                    </div>

                    <p className='z-10 font-semibold text-2xl'>Science Laboratories</p>
                ...
                <div className="relative bg-[url('/hero.png')] bg-cover bg-center h-60 flex flex-col justify-end items-start text-white p-8 rounded-lg">
                    ...
                    <p className='z-10 font-semibold text-2xl'>Library & Media Center</p>
                    <p className='z-10 text-left font-light'>
                ...
                <div className="relative bg-[url('/hero.png')] bg-cover bg-center h-60 flex flex-col justify-end items-start text-white p-8 rounded-lg">
                    ...
                    <p className='z-10 font-semibold text-2xl'>Athletic Facilities</p>
                    <p className='z-10 text-left font-light'>
                ...
                <div className="relative bg-[url('/hero.png')] bg-cover bg-center h-60 flex flex-col justify-end items-start text-white p-8 rounded-lg">
                    ...
                    <p className='z-10 font-semibold text-2xl'>Arts Center</p>
                    <p className='z-10 text-left font-light'>
                ...
                <div className="relative bg-[url('/hero.png')] bg-cover bg-center h-60 flex flex-col justify-end items-start text-white p-8 rounded-lg">
                    ...
                    <p className='z-10 font-semibold text-2xl'>Technology Hub</p>
                    <p className='z-10 text-left font-light'>
