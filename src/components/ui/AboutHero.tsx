              ...
              >
                ...
                <div className="space-y-2 mb-8">
                  <h2 className="text-3xl lg:text-4xl font-semibold text-yellow-400">
                    About Ridges International School
                  </h2>
                  {/* <h2 className="text-3xl lg:text-4xl font-semibold text-yellow-400">
                    Inspiring Futures
                  </h2> */}
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/mission" className="bg-yellow-400 text-neutral-900 font-semibold py-3 px-6 rounded-lg hover:bg-yellow-500 transition duration-300">
                    Our Mission
                  </Link>
