...
//   const totalBlogs: number = await prisma.post.count();
//   const totalPages: number = Math.ceil(totalBlogs / ITEMS_PER_PAGE);
...
//         <div className="min-h-screen bg-gray-50 py-12">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//             <div className="p-20 relative h-[300px] w-full bg-[url('/blog.jpg')] bg-cover bg-center my-6 mt-10">

//             <div className="absolute inset-0 bg-neutral-800 opacity-70"></div>

//               <h1 className="text-4xl font-bold  text-white inset-1 z-20">School Blog</h1>
