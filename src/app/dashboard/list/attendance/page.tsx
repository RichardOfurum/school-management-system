...
const renderRow = (item: AttendanceList, role: string | undefined) => (
  <tr key={item.id} className='border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-lamaPurpleLight'>
    <td className='flex gap-4 p-4 flex-col justify-items-start'>
      <span className='font-semibold'>{item.student.name} <br />{item.student.surname}</span>
    </td>
    <td className=''>
    ...
    <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0 flex flex-col justify-between'>
      <div>
        ...
        <div className='md:flex items-center justify-between'>
          <h1 className='text-lg font-semibold mb-4'>All Attendances</h1>
...
// type AttendanceList = Attendance & {student: Student} & {lesson: Lesson} & {class:Class}
...
//         <span className='font-semibold'>{item.student.surname}</span>
